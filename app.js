...
app.get('/popup_id_check',function(req, res){
      res.render('popup_id_check',{errormsg : "", checked_ID :""});
});
app.get('/popup_id_check_error',function(req, res){
      res.render('popup_id_check',{errormsg : "중복된 아이디가 있습니다.", checked_ID :""});
});
app.get('/popup_success_id',function(req, res){
      res.render('popup_success_id');
});
